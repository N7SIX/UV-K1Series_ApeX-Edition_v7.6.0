...
### Build Details
- **Firmware**: n7six.ApeX-k5v1.v7.6.10C.bin
...
### 1. **MDC_DIRECT_HEX_INPUT_v7.6.10C.md**
...
### Documentation
- `documentation/MDC_DIRECT_HEX_INPUT_v7.6.10C.md` - Technical reference
...
### Compiled Firmware
- `build/ApeX/n7six.ApeX-k5v1.v7.6.10C.bin` - Ready-to-flash binary (111 KB)
...
**For Technical Details**: See `MDC_DIRECT_HEX_INPUT_v7.6.10C.md`  

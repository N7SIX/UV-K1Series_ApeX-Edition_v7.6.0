# MDC-1200 Menu & Configuration Guide — v7.6.10B

**Date**: 2026-08-16  
**Version**: v7.6.10B  
**Status**: ✅ COMPLETE & VERIFIED  
**Build**: n7six.ApeX-k1.v7.6.10B.bin (111 KB)  
...
- `MDC1200_MENU_IMPLEMENTATION_v7.6.10B.md` (detailed menu/EERPOM safety analysis)
- `MDC_HEX_INPUT_IMPLEMENTATION_REPORT.md` (direct hex input)
- `MDC_DIRECT_HEX_INPUT_v7.6.10B.md` (hex input technical reference)
...
1. **Three new menu items** for MDC-1200 configuration:
   ...
   - `MENU_MDC_OP` — MDC Opcode (0x00–0x07)
   - `MENU_MDC_ARG` — MDC Argument (0x00–0x0F)
...
4. **Decoder functionality** (from v7.6.10B):
...
### MENU_MDC_OP — Opcode Selection

| Property | Value |
|----------|-------|
| Display name | "MDC OP" |
| Type | Submenu (8 options) |
| Default | Status (0x00) |
...
### MENU_MDC_ARG — Argument Selection

| Property | Value |
|----------|-------|
| Display name | "MDC ARG" |
| Type | Submenu (16 options) |
| Default | 0x00 |

**Submenu values**: `0x00` through `0x0F`
...
| File | Lines | Changes |
|------|-------|---------|
| `App/ui/menu.h` | — | Added `MENU_MDC_ID`, `MENU_MDC_OP`, `MENU_MDC_ARG` enum values |
...
|---------|-----------|--------|--------|---------|
| Status Report | MDC-1200 | 0x1234 | Status | 0x00 |
| Emergency | MDC-1200 | 0x0000 | Emerg | 0x01 |
| Command | MDC-1200 | 0x5678 | Command | 0x0F |
...
✅ Firmware size: 115 KB (n7six.ApeX-k1.v7.6.10B.bin)
...
ls -lh build/ApeX/n7six.ApeX-k1.v7.6.10B.bin
```

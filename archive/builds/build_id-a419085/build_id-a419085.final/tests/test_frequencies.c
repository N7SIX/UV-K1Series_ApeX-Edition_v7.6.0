...
{
    /* Standard 12.5 kHz step (1250) */
    TEST_ASSERT_EQ_U32(FREQUENCY_RoundToStep(43450000, 1250), 43450000);
    TEST_ASSERT_EQ_U32(FREQUENCY_RoundToStep(43450625, 1250), 43450000);
...
static void test_TX_freq_check(void)
{
    ...
    TEST_ASSERT_EQ_INT(TX_freq_check(14500000), 0);
    TEST_ASSERT_EQ_INT(TX_freq_check(43500000), -1);  // 435 MHz outside 430-440

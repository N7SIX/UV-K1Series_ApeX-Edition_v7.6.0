...
> **Date:** 2026-06-26  
> **Update (2026-08-01):** No EEPROM layout changes were made during the optimization pass.
> All modifications (frequencies.c, waterfall.c, app.c, radio.c) operate on RAM-only
> or flash-only data and do not touch EEPROM data format or mapping tables.

...
> **Firmware:** UV-K1Series ApeX-Edition v7.6.9D  
> **Radio:** Quansheng UV-K5/K1 Series (PY32F071 + BK4819)  
> **Display:** ST7565 128×64 LCD  
> **Last Updated:** 2026-08-06  
> **Update (2026-08-01):** Waterfall robustness improved - added NULL pointer guard
> in `rssiToDbm()` and out-of-bounds array check for `peakIndex` in `waterfall.c`.
> No UX/behavior changes. See `CHANGELOG.md`.
> **Update (2026-08-06):** v7.6.9D - Build system consolidated to ApeX-only, K5Viewer stuttering reduced, BUILD_ID verified as Unix timestamp in hex. No spectrum/waterfall UX changes.
...
*This guide is based on the source code analysis of spectrum.c (2,681 lines), waterfall.c (226 lines), frequencies.c, and radio.h from UV-K1Series ApeX-Edition v7.6.0.*

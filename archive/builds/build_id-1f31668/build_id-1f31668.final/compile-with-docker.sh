...
# ---------------------------------------------
# Create a restore point after successful build, including build outputs
# ---------------------------------------------
echo "📦 Creating post-build restore point (including build folder)..."
export PRESET="${PRESET}"
export INCLUDE_BUILD="true"
bash tools/make_restore_point.sh

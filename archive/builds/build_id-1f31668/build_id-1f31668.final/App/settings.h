...
//#endif                                // Fix me !!! What the hell is this?
    ...
    uint8_t               field_cw_0xa6;
    uint8_t               field_cw_0xa7;
    uint8_t               field_cw_0xa8;
    uint8_t               field_cw_0xa9;
    uint8_t               field_cw_0xaa;
    uint8_t               field_cw_0xab;
    uint8_t               field_cw_0xac;
    uint8_t               field_cw_0xad;
    uint8_t               field_cw_0xae;
    uint8_t               field_cw_0xaf;
#endif
} EEPROM_Config_t;

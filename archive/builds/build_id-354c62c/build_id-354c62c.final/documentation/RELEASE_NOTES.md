...
### Version Guide (Newest to Oldest)
...
| **v7.6.10C (Post-release fixes)** | **MDC-1200 ID Fix (Earlier Attempt).** An earlier fix for the MDC-1200 "no ID displayed" problem. It worked partially but was later improved by the full fix above. |
...
### Problem Solved
MDC-1200/MDC1200L PTT-ID mode: receiving radio could not decode transmitted bursts — no MDC-ID displayed after RX.

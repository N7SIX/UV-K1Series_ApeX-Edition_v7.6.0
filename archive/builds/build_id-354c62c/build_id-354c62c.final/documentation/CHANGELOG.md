...
### Problem
MDC-1200/MDC1200L PTT-ID mode transmitted bursts that the receiving radio could not decode — no MDC-ID displayed after RX. Root cause: the BK4829 hardware framing layer had multiple defects preventing the RX FIFO from capturing complete frames.

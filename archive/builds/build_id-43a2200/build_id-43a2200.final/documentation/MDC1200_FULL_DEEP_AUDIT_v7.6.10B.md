...
**Version audited**: v7.6.10B (App/mdc1200.c, App/mdc1200.h, App/driver/bk4819.c, App/driver/bk4829.c)
**Date**: 2026-08-15
...
`MDC1200_Transmit()` was defined only in `driver/bk4819.c`, but `App/CMakeLists.txt` builds only `driver/bk4829.c`. The header-declared public API therefore did not exist in the compiled firmware. Added a matching implementation to `bk4829.c`.

...
> **Firmware:** UV-K1Series ApeX-Edition v7.6.0/7.6.9D
> **Date:** 2026-06-26  
> **Reviewer:** N7SIX  
> **Update (2026-08-01):** Implementation status added. See "FIX STATUS" sections.  
> **Update (2026-08-06):** v7.6.9D changes documented below.
>
> **Update (2026-08-08):** v7.6.9F changes documented below.
...
### Bug Fixes
- **TX red LED indicator** — restored by correcting `UI_MAIN_SetRxLed()` LED ownership during transmit
- **Repeater Tail Tone Elimination (RTTE) Power Amplifier Timing** — fixed critical timing issue where PA was disabled before RTTE countdown, preventing tail tone transmission to repeaters. Modified `APP_HandleEndTransmission()` to delay PA shutdown until after RTTE countdown completes, ensuring proper repeater operation.

...
> **Project:** UV-K1Series ApeX-Edition v7.6.0/7.6.9D
...
> **Date:** 2026-06-26  
> **Update (2026-08-01):** See `CHANGELOG.md` for v7.6.9B modifications:
> - K5Viewer rate limiting (fixes key stutter in `app.c`)
> - Tail tone reduced to 100ms (`radio.c`)
> - Frequency clamp helpers added (`frequencies.c`/`frequencies.h`)
> - ISR safety invariants added (`st7565.h`, `waterfall.h`)
> - Waterfall NULL/OOB security fixes (`waterfall.c`)
>
> **Update (2026-08-06):** See `CHANGELOG.md` for v7.6.9D modifications:
> - Stock/NOGIT variant removed — ApeX-only build
...
> - K5Viewer stuttering reduced to 2s update interval
> - Audio bar smoothness overhaul (50ms update, symmetric smoothing, line-only blit, TX warm-up)
> - BUILD_ID verified as Unix timestamp in hex
>
> **Update (2026-08-08):** See `CHANGELOG.md` for v7.6.9F modifications:
> - `misc.h` refactored into scoped modules under `App/globals/`
> - `App/frequencies.c` include order normalized; duplicate includes removed
> - Missing API declarations exposed in `App/frequencies.h`
> - Doxygen `@brief` added to core public headers
> - EEPROM struct reserved fields annotated in `App/settings.h`
> - Host-side unit tests added for `frequencies.c`, `dcs.c`, `crc.c`
> - Static-analysis helper and CMake target added
> - GitHub Actions CI added for build/test/static-analysis
> - TX red LED indicator restored
>
> All changes preserve EEPROM layout, calibration data, and existing logic.
...
App/ structure:
  ...
  app/      app.c/h, action.c/h, main.c/h, menu.c/h, common.c/h,
            ...
            beam.c/h, fm.c/h, rega.c/h, uart.c/h,
            keyboard_state.h
...
BK4819_ReadRegister(uint8_t reg);
BK4819_GetRSSI();
...
Rendering primitives: `UI_PrintString()`, `UI_DrawPixelBuffer()`, `UI_DrawLineBuffer()`.
